...
To vendor stdlib functionality and avoid installing dependency trees for Node.js, you may use the UMD server build,```javascript
isString = require( 'path/to/vendor/umd/assert-is-string/index.js' )
```
